...
const CaseStudyHero: FC<CaseStudyHeroProps> = ({ slice }) => {
  return (
    <div className="bg-[#202020] relative w-full" data-name="Hero">
      ...
      {/* Desktop layout (xl+) - percentage-based positioning */}
      <div className="hidden xl:block h-[982px]">
        {/* Background floor plan image */}
        <div className="absolute left-[200px] mix-blend-lighten size-[712px] top-[141px]">
        ...
        <div className="absolute left-[-200px] top-[213px] w-[949px] h-[648px] origin-top-left scale-[0.85] min-[1400px]:scale-[0.95] min-[1500px]:scale-100 min-[1600px]:scale-105 min-[1800px]:scale-110">
          {/* Large grayscale screenshot - back */}
          <div className="absolute h-[648px] left-0 top-0 pointer-events-none rounded-[10px] w-[749px] grayscale">
            <img alt="" className="absolute inset-0 max-w-none object-center object-cover rounded-[10px] size-full" src="/images/7cb822792a81c85b92c6b0dfcca5d9d03cf0a990.png" />
          ...
          <div className="absolute h-[553px] left-[542px] rounded-[10px] top-[47px] w-[407px]">
            <img alt="" className="absolute inset-0 max-w-none object-center object-cover pointer-events-none rounded-[10px] size-full" src="/images/1464d2a6761181a16640ae6b4d5125ddc1739c02.png" />
          </div>
        </div>

        {/* Red vertical line with gradient */}
        <div className="absolute flex h-[982px] items-center justify-center left-[38%] top-0 w-0">
            ...
            <div className="h-[982px] relative w-0">
              <div className="absolute inset-[0_-0.63px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.2593 982">
                  <path d="M0.62965 0V982" stroke="url(#paint0_linear_case_study)" strokeWidth="1.2593" />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_case_study" x1="1.11405" x2="1.11405" y1="114.734" y2="953.479">
        ...
        {/* Red dot on line */}
        <div className="absolute left-[calc(38%-3px)] size-[5.037px] top-[404.75px]">
        ...
        {/* 1345 text */}
        <div className="absolute flex flex-col font-mono justify-center leading-[0] left-[calc(38%+20px)] not-italic text-[#ec0606] text-[20px] top-[406px] tracking-[-1px] -translate-y-1/2 uppercase">
          <p className="leading-[normal]">1345</p>
        </div>

        {/* Text content - vertically centered */}
        <div className="absolute content-stretch flex flex-col gap-[25px] items-start right-[12%] top-1/2 -translate-y-1/2 w-[40%] max-w-[523px]">
          {/* Badge */}
      ...
      <div className="xl:hidden flex flex-col min-h-screen">
        ...
        <div className="relative w-full h-[400px] sm:h-[450px] md:h-[500px] lg:h-[550px] mt-[80px]">
          ...
          {/* Large grayscale screenshot */}
          <div className="absolute h-[85%] left-[5%] pointer-events-none rounded-[10px] top-[10%] w-[70%] sm:w-[65%] md:w-[60%]">
            <div className="absolute inset-0 overflow-hidden rounded-[10px]">
              <img alt="" className="absolute h-full left-0 max-w-none top-0 w-full grayscale object-cover" src="/images/7cb822792a81c85b92c6b0dfcca5d9d03cf0a990.png" />
            </div>
            <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.02)] border-solid inset-[-2px] rounded-[12px]" />
          </div>
